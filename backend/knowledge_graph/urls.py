...
from .views import TopicNodeListCreateView, TopicNodeDetailView, GraphDataView, TopicRelationListCreateView
...
urlpatterns = [
   ...
   path("graph/<int:course_id>/", GraphDataView.as_view(), name="graph-course-data"),
    ...
    path("relations/", TopicRelationListCreateView.as_view()),
]